...
class DataTransformation:
    ...
    def get_new_features(self, train_set: DataFrame, test_set: DataFrame) -> DataFrame:
        ...
        for key in datasets:
            ...
            dataset["Education"] = dataset["Education"].replace({ "Basic":0,"2n Cycle":1,"Graduation":2,"Master":3,"PhD":4}).astype(int) 
    ...
    def transform_data(self,train_set:DataFrame, test_set:DataFrame) -> DataFrame:
        ...
        try:
            ...
            # keep all remaining numeric columns INCLUDING NumWebVisitsMonth
